/**
 * 브라우저에 담아 두는 연락처 기본값 — 프로젝트마다 부서명·담당자·전화·이메일·우편주소를
...
const CONTACT = { 부서명: "북부지소", 담당자: "홍길동 팀장", 전화: "054-900-3801", 이메일: "gepa_north@naver.com", 우편주소: "경상북도 안동시 북순환로 387" };
...
describe("연락처 pref 왕복", () => {
  ...
  it("빠진 칸은 빈 문자열로 채워 담는다 — 담당자·우편주소는 선택 입력이다", () => {
    useStore(memoryStore());
    saveContactPref({ 부서명: "마케팅팀", 전화: "054-100-1000", 이메일: "a@gepa.kr" });
    expect(readContactPref()).toEqual({ 부서명: "마케팅팀", 담당자: "", 전화: "054-100-1000", 이메일: "a@gepa.kr", 우편주소: "" });
  });
