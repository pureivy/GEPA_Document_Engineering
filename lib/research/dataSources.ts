...
export const DATA_GO_KR_CATALOG: readonly DataGoKrService[] = [
  ...
  { id: "15101609", name: "관세청_품목별 수출입실적(GW)", org: "관세청", use: "품목별 수출입", dailyLimit: 10_000, endpoint: null },
  ...
  { id: "15087611", name: "한국산업단지공단_공장등록생산정보조회서비스", org: "한국산업단지공단", use: "등록공장 기본정보·업종·생산품(중소기업 사업 대상 모수)", dailyLimit: 1_000, endpoint: null },
  { id: "15034830", name: "대한무역투자진흥공사_국가정보", org: "KOTRA", use: "국가별 시장·비즈니스 환경 개요", dailyLimit: 10_000, endpoint: null },
  { id: "15122665", name: "대한무역투자진흥공사_국가별 물가정보", org: "KOTRA", use: "국가별 소비재 단가", dailyLimit: 10_000, endpoint: null },
  { id: "15107303", name: "행정안전부_통계연보_지역별 주민등록인구", org: "행정안전부", use: "지역별 인구·세대·남녀", dailyLimit: 10_000, endpoint: null },
