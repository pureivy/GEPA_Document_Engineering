...
import { replayFixture } from "@/lib/agents/replayFixtures";
...
const bodySchema = z.object({
  ...
  stage: z.enum(["notice"]).default("notice"),
  fixture: z.enum(["notice-golden", "notice-double"]).default("notice-golden"),
...
export async function POST(req: Request) {
  ...
  const lines = replayFixture(body.data.fixture, filePath);
  try {
